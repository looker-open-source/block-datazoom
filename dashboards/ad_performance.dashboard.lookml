- dashboard: ad_performance
  ...
  - title: Ad tolerance by country
    ...
    filters:
      datazoom_raw.timestamp_date: 7 days ago for 7 days
      datazoom_raw.Distinct_Ad_Break_Starts: ">100"
    ...
    map_latitude: 28.767659105691255
    map_longitude: 13.183593750000002
    map_zoom: 2
  ...
  - title: Ad completion funnel
    ...
    filters:
      datazoom_raw.timestamp_date: 7 days ago for 7 days
      datazoom_raw.event_type: milestone
      datazoom_raw.media_type: ad
    sorts: [datazoom_raw.milestone_percent]
    limit: 500
    query_timezone: America/New_York
    leftAxisLabelVisible: false
    leftAxisLabel: ''
  ...
  - name: README
    type: text
    title_text: README
    subtitle_text: Used by ad ops and ad sales teams
    body_text: |-
  ...
  - title: Ad performance required events
    ...
    filters:
      datazoom_raw.event_type: '"ad_break_end","ad_break_start","ad_click","ad_impression","media_request","media_loaded",milestone'
